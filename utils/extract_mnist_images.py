...
if __name__ == '__main__':
    extract_images('DDPM-Pytorch/data/train/images', 'DDPM-Pytorch/data/mnist_train.csv')
    extract_images('DDPM-Pytorch/data/test/images', 'DDPM-Pytorch/data/mnist_test.csv')